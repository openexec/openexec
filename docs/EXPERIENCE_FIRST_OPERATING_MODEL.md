...
2026-08-17. Creating and answering it is reserved for the owner. A machine may
...
borrowed because the portfolio purpose sounds related.
...
- The owner authors OpenExec's missing root `PROJECT_INTENT.md`; until then the
  OpenExec initiative gate reports `needs_owner` rather than inferring it from
  README copy, source code, Agent Console intent, or generated `INTENT.md`.
