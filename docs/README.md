...
| Document | State |
|---|---|
| [EXPERIENCE_FIRST_OPERATING_MODEL.md](EXPERIENCE_FIRST_OPERATING_MODEL.md) | Owner-directed Experience First and Finish What Matters operating model, including focus, magical moment, demo, website/pitch communication, whole-product and Taste Reviews, with E0–E4 and F1–F3 implementation stages. Documented, not enforced. OpenExec still lacks its owner-authored root `PROJECT_INTENT.md`; [the unanswered questions](OPENEXEC_PROJECT_INTENT_QUESTIONS.md) are non-authoritative interview preparation. |
